        ...
        <div id="blog-post">
            <div class="row">
                ...
                <div class="col-md-8 post">
                    ...
                    <?php if (!empty($comments)) : ?>
                        <div class="post-comment">
                            <div class="section-title bottom_10 top_30"><span></span>
                                <h2>Comments - (<?php if (!empty($total_comment)) {
                                                    echo html_escape($total_comment);
                                                } ?>)</h2>
                            </div>
                            <ul>
                    ...
                    <div class="leave-comment">
                        <div class="section-title bottom_30 top_60"><span></span>
                ...
                <div class="col-md-4 blog-sidebar">
                    ...
                    <!-- Popular Post -->
                    <div class="post-list">
                        <div class="section-title bottom_15"><span></span>
                            <h3>Related Posts</h3>
                        </div>
                    ...
                    <div class="category bottom_30">
                        <div class="section-title bottom_15 top_15"><span></span>
                            <h3>Categories</h3>
                        </div>

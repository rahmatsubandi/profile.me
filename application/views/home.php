    ...
    <div class="container">
        <div class="row equal-height">
            <div class="col-xs-12 col-sm-12 col-md-5">
                ...
                <h2 class="head-title-sm wow fadeInLeft" data-wow-delay="0.7s">Now making CV or Resume is as easy as peeling peanut shells!</h2>
                <div class="space-40"></div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-7">
                <div class="hidden visible-xs visible-sm space-60"></div>
                <figure class="wow fadeInRight" data-wow-delay="0.7s">
                    <img draggable="false" src="<?php echo base_url() ?>assets/front/images/header-shape-2.png" alt="illustration">
                </figure>
            </div>
        </div>
    </div>
